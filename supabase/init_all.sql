-- ============================================================
-- FULL SETUP SCRIPT: Paste this into the Supabase SQL Editor
-- Run the ENTIRE script at once to configure your database.
-- ============================================================
...
create table if not exists public.ad_requests (
  ...
  role text check (role in ('student_to_tutor', 'tutor_to_student')),
  message text,
...
-- 9. ADMIN & ROLE MANAGEMENT (redeem_code)
...
-- 12. Fix existing auth.users references (idempotent helper)
