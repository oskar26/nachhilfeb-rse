                ...
                {GRADES.map(g => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                "w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold border transition-all duration-300",
                                isActive
                                    ? "bg-primary text-black border-primary ring-2 ring-primary ring-offset-2 scale-110"
