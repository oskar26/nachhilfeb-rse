...
>(({ className, value, onClick, children, ...props }, ref) => {
    ...
    return (
        <button
            ...
            type="button"
            className={cn(
                "relative inline-flex items-center justify-center whitespace-nowrap rounded-xl px-4 py-2 text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] dark:focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 select-none cursor-pointer z-10",
                isActive
...
>(({ className, value, children, ...props }, ref) => {
    ...
    return (
        <motion.div
            ...
            className={cn(
                "mt-3 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] dark:focus-visible:ring-primary",
                className
            )}
            {...(props as any)}
        >
