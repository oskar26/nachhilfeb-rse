...
const subjectColorMap: Record<Subject, string> = {
    // Aufgabenfeld 1 — jede Sprache/Kunst eigene Farbe (keine identischen Duplikate)
    ...
    franzoesisch: 'bg-sky-100/90 text-sky-900 dark:bg-sky-950/60 dark:text-sky-200 border border-sky-200/80 dark:border-sky-800/50',
    ...
    latein: 'bg-stone-200/90 text-stone-900 dark:bg-stone-800/60 dark:text-stone-200 border border-stone-300/80 dark:border-stone-700/50',
    ...
    wirtschaft_gesell: 'bg-slate-100/90 text-slate-900 dark:bg-slate-800/60 dark:text-slate-200 border border-slate-300/80 dark:border-slate-700/50',
    wirtschaft_politik: 'bg-stone-100/90 text-stone-900 dark:bg-stone-800/60 dark:text-stone-200 border border-stone-300/80 dark:border-stone-700/50',

    // Aufgabenfeld 3 — mathematik rot (passt zu tailwind subject.mathematik #D62728)
    ...
    informatik: 'bg-slate-200/90 text-slate-900 dark:bg-slate-800/70 dark:text-slate-200 border border-slate-300/80 dark:border-slate-700/50',
    mathematik: 'bg-red-100/90 text-red-900 dark:bg-red-950/60 dark:text-red-200 border border-red-200/80 dark:border-red-800/50',
    ...
    // Aufgabenfeld 4 — verwandte Fächer gleiche Farbfamilie, dunklere Stufe (unterscheidbar)
    prakt_philosophie: 'bg-violet-200/90 text-violet-950 dark:bg-violet-900/50 dark:text-violet-200 border border-violet-300/80 dark:border-violet-700/50',
    religion: 'bg-amber-200/90 text-amber-950 dark:bg-amber-900/50 dark:text-amber-200 border border-amber-300/80 dark:border-amber-700/50',
